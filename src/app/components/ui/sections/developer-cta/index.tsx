...
const STEPS: Step[] = [
  {
    num: "01",
    title: "Learn",
    desc: "Read the docs and understand Tokamak's L2 architecture",
    cta: "Open Docs",
    href: LINKS.DOCS,
    icon: <BookOpen size={20} />,
    command: "npx tokamak init --docs",
    color: "#0ea5e9",
  },
  {
    num: "02",
    title: "Build",
    desc: "Clone repos, explore code, and start your rollup",
    cta: "View Code",
    href: LINKS.GITHUB,
    icon: <Github size={20} />,
  ...
  },
  {
    num: "03",
    title: "Launch",
    desc: "Get funded through grants and ship to production",
    cta: "Apply Now",
    href: LINKS.GRANT,
    icon: <Award size={20} />,
    command: "tokamak deploy --mainnet",
    color: "#a855f7",
  },
];

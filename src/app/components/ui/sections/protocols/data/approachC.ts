import type { ProtocolCardWithBadgeProps } from "../ProtocolCardWithBadge";
...
export const protocolsDataC: readonly ProtocolCardWithBadgeProps[] = [
  {
    ...
    badge: { label: "1.2M changes", level: "high" },
  },
  {
    ...
    badge: { label: "High activity", level: "high" },
  },
  {
    icon: zkEvmIcon,
    ...
    badge: { label: "890K changes", level: "high" },
  },
  {
    ...
    badge: { label: "Medium activity", level: "medium" },
  },
  {
    icon: crossChainIcon,
    ...
    badge: { label: "320K changes", level: "medium" },
  },
  {
    icon: securityIcon,
  ...
  },
  {
    ...
    badge: { label: "210K changes", level: "medium" },
  },
  {
    icon: randomnessIcon,
    ...
    badge: { label: "Low activity", level: "low" },
  },
  {
    icon: sybilIcon,
    ...
    badge: { label: "150K changes", level: "low" },
  },
  {
    icon: governanceIcon,
  ...
  },
  {
    ...
    badge: { label: "180K changes", level: "medium" },
  },
  {
    icon: gemStonIcon,
    title: "GemSton",
    ...
    badge: { label: "95K changes", level: "low" },
  },
] as const;

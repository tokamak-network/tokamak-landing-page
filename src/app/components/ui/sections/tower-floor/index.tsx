...
export default function TowerFloor({
  ...
  return (
    <div ref={ref}>
      {/* ── Mobile: normal flow, no background image ── */}
      <div
      ...
      {/* ── Desktop: fixed-height floor with background image ── */}
      <div
        className="hidden md:flex relative h-screen items-center justify-center overflow-hidden bg-black"
        style={{ scrollSnapAlign: "start" }}
      >
        <div
